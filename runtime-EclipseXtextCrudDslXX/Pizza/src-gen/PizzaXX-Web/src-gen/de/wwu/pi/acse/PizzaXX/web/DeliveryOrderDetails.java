...
public class DeliveryOrderDetails {
	...
	public DeliveryOrder getDeliveryOrder() {
		if (deliveryOrder == null) {
			deliveryOrder = deliveryOrderService.getWithFetchedReferences(id);
		}
	...
	private String toPage() {
		return "/deliveryOrder/DeliveryOrderDetails.xhtml?faces-redirect=true&id=" + id;
	}

	public String remove() {
		deliveryOrderService.remove(id);
		return "/deliveryOrder/DeliveryOrderList.xhtml";
	}

	public String addToOrderLines() {
		resetError();
		try  {
			deliveryOrderService.addToOrderLines(id, quantityForNewOrderLines, dishForNewOrderLines);
		} catch (EJBException e) {
	...
	protected Integer quantityForNewOrderLines;
	public Integer getQuantityForNewOrderLines() {
		return quantityForNewOrderLines;
	}
	public void setQuantityForNewOrderLines(Integer quantity) {
		this.quantityForNewOrderLines = quantity;
	}
	protected Dish dishForNewOrderLines;
